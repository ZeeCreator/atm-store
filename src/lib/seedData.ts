 ...
 * Sample Data Seeder
 * 
 * Jalankan script ini untuk mengisi database dengan sample products
 * 
 * Usage:
 * 1. Buka browser console di halaman /admin
 * 2. Copy paste script ini
 * 3. Atau jalankan via Node.js dengan firebase admin SDK
 */
...
// Run seeder
// Uncomment the line below to run in browser console
// seedProducts();
